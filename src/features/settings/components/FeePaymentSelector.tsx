...
import { useFeeJuiceBalance } from '../hooks/useFeeJuiceBalance';
import { useFeePayerAddress } from '../hooks/useFeePayerAddress';
import {
  FEE_PAYMENT_METHOD_LABELS,
  FEE_PAYMENT_METHOD_DESCRIPTIONS,
  getAvailableFeePaymentMethods,
  type FeePaymentMethodType,
} from '../config/feePayment';
...
export interface FeePaymentSelectorProps {
