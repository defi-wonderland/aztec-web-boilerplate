...
import { NetworkSelector, ConfigPanel } from './components';
...
export const SettingsCard: React.FC = () => {
  const { networkName, switchNetwork, disconnect, isConnected, walletType } =
    useAztecWallet();
  ...
  const showHealthMetrics =
    isConnected && walletType !== WalletType.BROWSER_WALLET;
