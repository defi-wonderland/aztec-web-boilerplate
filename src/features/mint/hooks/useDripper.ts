...
import { useFeeJuiceBalanceInvalidation } from '../../settings/hooks/useFeeJuiceBalance';
import { mintFeatureContracts } from '../config/contracts';
import type { FeePaymentMethodType } from '../../settings/config/feePayment';
...
export const useDripper = (options: UseDripperOptions = {}) => {
  ...
  const dripperAddress = mintFeatureContracts.dripper.address(currentConfig);
