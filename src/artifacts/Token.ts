...
export class TokenContract extends ContractBase {
   ...
   */
  public static deploy(wallet: Wallet, name: string, symbol: string, decimals: (bigint | number), asset: AztecAddressLike, vault_offset: (bigint | number), upgrade_authority: AztecAddressLike) {
   ...
   */
  public static deployWithPublicKeys(publicKeys: PublicKeys, wallet: Wallet, name: string, symbol: string, decimals: (bigint | number), asset: AztecAddressLike, vault_offset: (bigint | number), upgrade_authority: AztecAddressLike) {
  ...
  public static get storage(): ContractStorageLayout<'name' | 'symbol' | 'decimals' | 'private_balances' | 'total_supply' | 'public_balances' | 'minter' | 'upgrade_authority' | 'asset' | 'vault_offset'> {
      return {
        name: {
      slot: new Fr(1n),
    },
...
vault_offset: {
      ...
      } as ContractStorageLayout<'name' | 'symbol' | 'decimals' | 'private_balances' | 'total_supply' | 'public_balances' | 'minter' | 'upgrade_authority' | 'asset' | 'vault_offset'>;
    }
  ...
  public declare methods: {
    ...
    /** asset() */
    asset: (() => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
    ...
    /** constructor_with_asset(name: string, symbol: string, decimals: integer, asset: struct, vault_offset: integer, upgrade_authority: struct) */
    constructor_with_asset: ((name: string, symbol: string, decimals: (bigint | number), asset: AztecAddressLike, vault_offset: (bigint | number), upgrade_authority: AztecAddressLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;

    /** constructor_with_asset_initial_deposit(name: string, symbol: string, decimals: integer, asset: struct, vault_offset: integer, upgrade_authority: struct, initial_deposit: integer, depositor: struct, _nonce: field) */
    constructor_with_asset_initial_deposit: ((name: string, symbol: string, decimals: (bigint | number), asset: AztecAddressLike, vault_offset: (bigint | number), upgrade_authority: AztecAddressLike, initial_deposit: (bigint | number), depositor: AztecAddressLike, _nonce: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
    ...
    /** convert_to_assets(shares: integer) */
    convert_to_assets: ((shares: (bigint | number)) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;

    /** convert_to_shares(assets: integer) */
    convert_to_shares: ((assets: (bigint | number)) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
    ...
    /** get_vault_offset() */
    get_vault_offset: (() => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
    ...
    /** max_deposit(receiver: struct) */
    max_deposit: ((receiver: AztecAddressLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;

    /** max_issue(receiver: struct) */
    max_issue: ((receiver: AztecAddressLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;

    /** max_redeem(owner: struct) */
    max_redeem: ((owner: AztecAddressLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;

    /** max_withdraw(owner: struct) */
    max_withdraw: ((owner: AztecAddressLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
    ...
    /** preview_deposit(assets: integer) */
    preview_deposit: ((assets: (bigint | number)) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;

    /** preview_issue(shares: integer) */
    preview_issue: ((shares: (bigint | number)) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;

    /** preview_redeem(shares: integer) */
    preview_redeem: ((shares: (bigint | number)) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;

    /** preview_withdraw(assets: integer) */
    preview_withdraw: ((assets: (bigint | number)) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
    ...
    /** total_assets() */
    total_assets: (() => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
